...
public:
	...
	static void initSDL (	const int& w, const int& h, const int& bpp,
	...
	static SDL_Surface* loadIMG (const string& filename);
	...
	static void renderSurface (	SDL_Surface* src,
