...
in the constructors, or somewhere.
...
public:																\
	...
	{																\
		return subject.event;										\
																	...
																	\
	unsigned int obsno(int i = -1) const							\
	{																\
		return subject.obsno( i );									\
	}																\
private:
...
public:
	...
	Subject() : observers(0), n_events(0), event(0)
	{
	}
	...
	unsigned int obsno(int i) const
	{
		unsigned int no = 0;
